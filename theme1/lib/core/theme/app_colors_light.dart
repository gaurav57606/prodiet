...
class AppColorsLight {
  ...
  static const Color bgCard          = Color(0x99FFFFFF); // --card-bg rgba(255,255,255,.6)
  static const Color bgCardShine     = Color(0xE6FFFFFF); // --card-shine rgba(255,255,255,.9)
  static const Color bgElevated      = Color(0xFFFFFFFF); // white elevated surface

  // Borders
  static const Color border          = Color(0x1FA064DC); // --card-bd rgba(160,100,220,.12)
  static const Color phoneBorder     = Color(0x33A064DC); // --phone-border rgba(160,100,220,.2)
  ...
  static const Color heroSub         = Color(0x73643CA0); // --hero-sub rgba(100,60,160,.45)
  static const Color heroCal         = Color(0xFF3A1060); // --hero-cal
  static const Color streakNumber    = Color(0xFFC07010); // --streak-n
  static const Color streakLabel     = Color(0x80B46E00); // --streak-l rgba(180,110,0,.5)

  // Section headers
  static const Color sectionTitle    = Color(0x59503278); // --sh-t rgba(80,50,120,.35)
  static const Color sectionLink     = Color(0xFF8030D0); // --sh-l

  // Nav / FAB
  static const Color navBg           = Color(0xF2F2ECFC); // --nav-bg rgba(242,236,252,.95)
  static const Color navBorder       = Color(0x26B48CFF); // --nav-bd rgba(180,140,255,.15)
  static const Color navIcon         = Color(0x40643CA0); // --nav-ic rgba(100,60,160,.25)
  static const Color navLabel        = Color(0x40643CA0); // --nav-lbl
  static const Color fabShadow       = Color(0x598C3CDC); // --fab-shadow rgba(140,60,220,.35)
  ...
  static const Color tileFatBg       = Color(0xB3FFFFFF); // --t-fat-bg rgba(255,255,255,.7)
  static const Color tileFatBorder   = Color(0x333CC8B4); // --t-fat-bd rgba(60,200,180,.2)
  static const Color tileFatColor    = Color(0xFF208080); // --t-fat-c
  static const Color tileFatDim      = Color(0x7314A08C); // --t-fat-cd rgba(20,160,140,.45)

  // Alert colors
  static const Color alertAmberBg    = Color(0x33FFBE50); // --al-a-bg
  static const Color alertAmberBd    = Color(0x40FFB43C); // --al-a-bd rgba(255,180,60,.25)
  ...
  static const Color alertVioletBd   = Color(0x38AA78FF); // --al-v-bd rgba(170,120,255,.22)
  ...
  static const Color alertGreenBd    = Color(0x3328C8AA); // --al-m-bd rgba(40,200,170,.2)
  static const Color alertGreen      = Color(0xFF106050); // --al-m-c
  static const Color alertGreenDot   = Color(0xFF20A080); // --al-m-dot

  // Water
  static const Color waterBg         = Color(0x40B4DCFF); // --w-bg rgba(180,220,255,.25)
  static const Color waterBorder     = Color(0x4D78B4FF); // --w-bd rgba(120,180,255,.3)
  static const Color waterLabel      = Color(0x993C78C8); // --w-lbl rgba(60,120,200,.6)
  ...
  static const Color dotPending      = Color(0x33502878); // --dot-pend rgba(80,40,120,.2)

  // Compensation
  static const Color compMissBg      = Color(0x14C82846); // --comp-miss rgba(200,40,70,.08)
  static const Color compMissBd      = Color(0x2EC82846); // --comp-miss-bd rgba(200,40,70,.18)
  static const Color compAdjBg       = Color(0x14149082); // --comp-adj rgba(20,160,130,.08)
  static const Color compAdjBd       = Color(0x26149082); // --comp-adj-bd rgba(20,160,130,.15)

  // Tags
  static const Color tagNormalBg     = Color(0x99FFFFFF); // --tag-n-bg rgba(255,255,255,.6)
  static const Color tagNormalBd     = Color(0x26A064DC); // --tag-n-bd rgba(160,100,220,.15)
  static const Color tagNormalColor  = Color(0x80502878); // --tag-n-c rgba(80,40,120,.5)
  static const Color tagSelBg        = Color(0x1AC82846); // --tag-sel-bg rgba(200,40,70,.1)
  static const Color tagSelBd        = Color(0x40C82846); // --tag-sel-bd rgba(200,40,70,.25)
  static const Color tagSelColor     = Color(0xFFA02040); // --tag-sel-c
  static const Color tagDietBg       = Color(0x1A8C50DC); // --tag-diet-bg rgba(140,80,220,.1)
  static const Color tagDietBd       = Color(0x408C50DC); // --tag-diet-bd rgba(140,80,220,.25)
