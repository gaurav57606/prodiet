...
class ActivitySyncScreen extends StatelessWidget {
  ...
  Widget _buildStatsRow(BuildContext context) {
    return Row(
      children: [
        _buildStatTile(context, '4,820', 'STEPS', AppColorSchemes.accentViolet),
        const SizedBox(width: AppSpacing.sm),
        _buildStatTile(context, '312', 'BURNED', AppColorSchemes.accentPink),
        const SizedBox(width: AppSpacing.sm),
        _buildStatTile(context, '48m', 'ACTIVE', AppColorSchemes.accentTeal),
      ],
    );
  }
    ...
    return DmCard(
      child: Column(
        ...
        children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: AppColorSchemes.chartConsumed.withOpacity(0.3),
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: AppColorSchemes.chartBurned,
                              borderRadius: const BorderRadius.vertical(top: Radius.circular(4)),
                            ),
                          ),
                        ],
          ...
          Row(
            children: [
              _buildLegendItem('Consumed', AppColorSchemes.chartConsumed.withOpacity(0.4)),
              const SizedBox(width: AppSpacing.md),
              _buildLegendItem('Burned', AppColorSchemes.chartBurned),
            ],
          ),
        ],
      ),
