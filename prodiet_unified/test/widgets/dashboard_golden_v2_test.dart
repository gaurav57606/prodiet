...
void main() {
  ...
  group('Dashboard Golden Tests V2', () {
    ...
    testWidgets('T1 Light Theme Dashboard Golden V2', (tester) async {
      ...
      await expectLater(find.byType(DashboardScreen), matchesGoldenFile('goldens/dashboard_t1_light_v2.png'));
    });
    ...
    testWidgets('T2 Dark Theme Dashboard Golden V2', (tester) async {
      ...
      await tester.pumpAndSettle();
      await expectLater(find.byType(DashboardScreen), matchesGoldenFile('goldens/dashboard_t2_dark_v2.png'));
    });
  });
}
