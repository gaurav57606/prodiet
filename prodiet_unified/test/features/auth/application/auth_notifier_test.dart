...
void main() {
  ...
  group('AuthNotifier — Initialization', () {
    ...
    test('transitions to AuthProfileMissing when profile is null after retry',
      ...
      fakeAsync((async) {
        ...
        // Advance past the 500ms delay in _handleSession
  ...
  group('AuthNotifier — completeOnboarding', () {
    test('calls updateProfile and fetchProfile, then emits Authenticated',
      ...
      fakeAsync((async) {
        ...
        authNotifier.completeOnboarding('u4', {
  ...
  group('AuthNotifier — signIn', () {
    test('sets AuthLoading synchronously then calls repo', () {
      fakeAsync((async) {
        ...
        authNotifier.signIn('e@t.com', 'pass');
        expect(authNotifier.state, isA<AuthLoading>());
    ...
    test('emits AuthFailure when repo throws', () {
      fakeAsync((async) {
        ...
        authNotifier.signIn('bad@t.com', 'wrong');
        async.flushMicrotasks();
  ...
  group('AuthNotifier — sendPasswordReset', () {
    test('calls repository with correct email', () {
      fakeAsync((async) {
        ...
        authNotifier.sendPasswordReset('r@t.com');
        async.flushMicrotasks();
    ...
    test('emits AuthFailure when repo throws', () {
      fakeAsync((async) {
        ...
        authNotifier.sendPasswordReset('nobody@t.com');
        async.flushMicrotasks();
