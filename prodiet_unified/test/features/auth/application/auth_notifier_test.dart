...
void main() {
  ...
  group('AuthNotifier Initialization', () {
    test(
        'should start in AuthLoading and transition to AuthUnauthenticated if no session',
        () async {
    ...
    test('should transition to AuthAuthenticated if session and profile exist',
        () async {
      final user = AppUser(
        id: 'u1',
        email: 'u1@test.com',
      ...
      await authNotifier.signIn(
          'u1@test.com', 'pass'); // This will call signIn in repo
