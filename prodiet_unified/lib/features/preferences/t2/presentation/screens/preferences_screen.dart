...
class _PreferencesScreenState extends ConsumerState<PreferencesScreen> {
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(context, "Cuisine Preferences", [
              ...
              const DmChip(
                  label: "Asian", isSelected: true, color: Color(0xFFB06EFF)),
            ...
            _buildSection(context, "Meal Frequency", [
              ...
              const DmChip(
                  label: "5 meals", isSelected: true, color: Color(0xFFB8FF00)),
  ...
  Widget _buildAllergyChip(String label) {
    ...
    return DmChip(
      ...
      onTap: () => setState(
          () => sel ? _allergies.remove(label) : _allergies.add(label)),
    );
  }
