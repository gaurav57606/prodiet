...
mixin _$WeightEntry {
  ...
  $WeightEntryCopyWith<WeightEntry> get copyWith =>
      _$WeightEntryCopyWithImpl<WeightEntry>(this as WeightEntry, _$identity);
...
abstract mixin class $WeightEntryCopyWith<$Res> {
  factory $WeightEntryCopyWith(
          WeightEntry value, $Res Function(WeightEntry) _then) =
      _$WeightEntryCopyWithImpl;
  @useResult
  $Res call({String id, String userId, double weightKg, DateTime loggedAt});
}

/// @nodoc
class _$WeightEntryCopyWithImpl<$Res> implements $WeightEntryCopyWith<$Res> {
...
extension WeightEntryPatterns on WeightEntry {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_WeightEntry value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(
            String id, String userId, double weightKg, DateTime loggedAt)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _WeightEntry() when $default != null:
        return $default(_that.id, _that.userId, _that.weightKg, _that.loggedAt);
      case _:
        return orElse();
    }
  }
...
class _WeightEntry implements WeightEntry {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$WeightEntryCopyWith<_WeightEntry> get copyWith =>
      __$WeightEntryCopyWithImpl<_WeightEntry>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$WeightEntryToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$WeightEntryCopyWith<$Res>
    implements $WeightEntryCopyWith<$Res> {
  factory _$WeightEntryCopyWith(
          _WeightEntry value, $Res Function(_WeightEntry) _then) =
      __$WeightEntryCopyWithImpl;
  @override
  @useResult
  $Res call({String id, String userId, double weightKg, DateTime loggedAt});
}
...
/// @nodoc
class __$WeightEntryCopyWithImpl<$Res> implements _$WeightEntryCopyWith<$Res> {
