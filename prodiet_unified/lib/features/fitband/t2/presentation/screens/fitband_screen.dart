              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            _buildDeviceChip(
                              fitState.hasPermission ? 'HEALTH SYNC ACTIVE' : 'NO HEALTH ACCESS', 
                              fitState.hasPermission ? T2Colors.lime : T2Colors.coral
                            ),
                            const SizedBox(width: 8),
                            _buildDeviceChip('CONNECTED', T2Colors.textSecondary),
                          ],
                        ),
                      ],
                    ),
                  ...
                  ListView.separated(
                    ...
                    itemCount: 3,
                    separatorBuilder: (_, __) => const Divider(color: T2Colors.border, height: 1),
