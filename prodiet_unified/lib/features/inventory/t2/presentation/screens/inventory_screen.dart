          ...
          SliverPadding(
            ...
            sliver: SliverGrid(
              ...
              delegate: SliverChildListDelegate([
                _buildStockTile('Milk', '1.2L left', Icons.opacity, T2Colors.sky, isLow: true),
                _buildStockTile('Chicken Breast', '800g', Icons.kebab_dining, T2Colors.coral),
                _buildStockTile('Quinoa', '2.5kg', Icons.grain, T2Colors.amber),
                _buildStockTile('Eggs', '4 left', Icons.egg, T2Colors.amber, isLow: true),
                _buildStockTile('Greek Yogurt', '2 packs', Icons.icecream, T2Colors.sky),
                _buildStockTile('Broccoli', '300g', Icons.eco, T2Colors.lime),
              ]),
            ),
          ),
  ...
  Widget _buildStockTile(String name, String qty, IconData icon, Color accent, {bool isLow = false}) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isLow ? T2Colors.coral.withOpacity(0.4) : T2Colors.border,
          width: isLow ? 1.5 : 1.0,
        ),
      ),
      child: Column(
