            ...
            child: Row(
              children: [
                Expanded(
                    ...
                    child: Container(color: T1ColorSchemes.macroProtein)),
                const SizedBox(width: 2),
                Expanded(
                    flex: (summary.totalCarbsG * 100 / totalMacros).toInt(),
                    child: Container(color: T1ColorSchemes.macroCarbs)),
                const SizedBox(width: 2),
                Expanded(
                    flex: (summary.totalFatG * 100 / totalMacros).toInt(),
                    child: Container(color: T1ColorSchemes.macroFat)),
              ],
            ),
          ),
        ),
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                _buildMacroDetail(theme, 'CALORIES', '${meal.calories.toInt()}',
                    theme.colorScheme.onSurface),
                _buildMacroDetail(theme, 'PROTEIN', '${meal.proteinG.toInt()}g',
                    T1ColorSchemes.macroProtein),
                _buildMacroDetail(theme, 'CARBS', '${meal.carbsG.toInt()}g',
                    T1ColorSchemes.macroCarbs),
                _buildMacroDetail(theme, 'FAT', '${meal.fatG.toInt()}g',
                    T1ColorSchemes.macroFat),
              ],
            ),
            const SizedBox(height: 24),
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: _inputDecoration(
                        theme, 'Meal Name (e.g. Chicken Salad)'),
                  ),
                  const SizedBox(height: 12),
