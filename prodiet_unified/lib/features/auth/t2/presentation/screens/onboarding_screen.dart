          ...
          child: Column(
            ...
            children: [
              ...
              const Text('Set your goals to personalise your plan',
                  style:
                      TextStyle(color: T2Colors.textSecondary, fontSize: 13)),
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            color: sel ? T2Colors.lime : T2Colors.border,
                            width: sel ? 1.5 : 1),
                      ),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                ...
                return Padding(
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: sel
                            ? T2Colors.lime.withValues(alpha: 0.08)
                            : T2Colors.bgElevated,
                            ...
                            children: [
                              Text(a.$1,
                                  style: GoogleFonts.barlowCondensed(
                                      ...
                                      color:
                                          sel ? T2Colors.lime : Colors.white)),
                              Text(a.$2,
                                  style: const TextStyle(
